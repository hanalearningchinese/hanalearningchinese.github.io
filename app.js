// ==========================================================================
// APP LOGIC: LESSON 67 (MAIN CONTROLLER)
...
// PDF GENERATION & TELEGRAM REPORTING
function setupReporting() {
  ...
  btnGChat.addEventListener('click', () => {
    soundEffects.click();
    sendReportToTelegram(state.gameQuiz.score);
  });
}
...
function generatePDF(score) {
  try {
    ...
    doc.text("- Nhan dien mat chu & binh am cua 23 tu vung cua bai.", 35, 175);
    doc.text("- Hoan thanh tro choi keo tha tu vung ghep toa xe lua.", 35, 183);
...
function sendReportToTelegram(score) {
  ...
  .then(() => {
    statusDiv.textContent = "Gửi báo cáo thành công! Check Telegram nhé mẹ ơi! ❤️";
