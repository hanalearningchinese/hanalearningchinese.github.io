// ==========================================================================
// APP LOGIC: LESSON 60 (偷偷溜上船 - Lén Lên Tàu)
...
const vocabularyList = [
  ...
  },
  {
    ...
    "sentence": "幸好船长没有发现我们。",
    "sentence_pinyin": "Xínghão chúanzhãng méiyõu fáxiàn wõmen.",
...
function generatePDF(score) {
  try {
    ...
    doc.text("Chuong Trinh: But Phep Thuat 60", 105, 45, { align: "center" });
    ...
    doc.setFont("helvetica", "normal");
    doc.text("Bai 60 - Tou tou liu shang chuan (Roi di bang tau hoa)", 70, 80);
...
function sendReportToGChat(score) {
  ...
  const payload = {
    student: "Hana",
    lesson: "Bài 60: 偷偷溜上船 (Rời đi bằng tàu hỏa)",
    score: score,
