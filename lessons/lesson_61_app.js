// ==========================================================================
// APP LOGIC: LESSON 61 (水下探险 - Thám Hiểm Dưới Nước)
...
const vocabularyList = [
  ...
  },
  {
    ...
    "meaning_en": "blue",
    "sentence": "海水是深蓝色的。",
    "sentence_pinyin": "Hǎishuǐ shì shēnlánsè de.",
...
function generatePDF(score) {
  try {
    ...
    doc.text("Chuong Trinh: But Phep Thuat 61", 105, 45, { align: "center" });
    ...
    doc.setFont("helvetica", "normal");
    doc.text("Bai 61 - Shui xia tan xian (Roi di bang tau hoa)", 70, 80);
...
function sendReportToGChat(score) {
  ...
  const payload = {
    student: "Hana",
    lesson: "Bài 61: 水下探险 (Rời đi bằng tàu hỏa)",
    score: score,
