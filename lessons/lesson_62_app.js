// ==========================================================================
// APP LOGIC: LESSON 62 (暴风雨 - Cơn Bão)
...
function generatePDF(score) {
  try {
    ...
    doc.text("Chuong Trinh: But Phep Thuat 62", 105, 45, { align: "center" });
    ...
    doc.setFont("helvetica", "normal");
    doc.text("Bai 62 - Bao feng yu (Roi di bang tau hoa)", 70, 80);
...
function sendReportToGChat(score) {
  ...
  const payload = {
    student: "Hana",
    lesson: "Bài 62: 暴风雨 (Rời đi bằng tàu hỏa)",
    score: score,
