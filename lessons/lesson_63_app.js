// ==========================================================================
// APP LOGIC: LESSON 63 (熊猫露露 - Gấu Trúc LuLu) - RPG Edition
...
const vocabularyList = [
  ...
  },
  {
    ...
    "sentence": "它叫露露，是只熊猫。",
    "sentence_pinyin": "Tā jiào Lùlù, shì zhī xióngmāo.",
  ...
  },
  {
    ...
    "sentence_pinyin": "Lùlù shì yìzhī fēicháng kě'ài de xiǎoxióngmāo.",
  ...
  },
  {
    ...
    "sentence_pinyin": "Xióngmāo de máofǎ shì hēibái xiāngjiān de.",
...
function generatePDF(score) {
  try {
    ...
    doc.text("Chuyen Di Thám Hiem: But Phep Thuat 63", 105, 45, { align: "center" });
    ...
    doc.setFont("helvetica", "normal");
    doc.text("Thanh Pho: Thành Đô (Bai 63 - Xiong mao Lu lu)", 70, 80);
...
function sendReportToGChat(score) {
  ...
  const payload = {
    student: "Hana",
    lesson: "Bai 63: Giao dien RPG - Quyết Đấu Boss Thành Đô",
    score: score,
