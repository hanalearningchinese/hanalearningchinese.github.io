// ==========================================================================
// APP LOGIC: LESSON 66 (在这儿见到你们真好！ - Gặp Được Các Bạn Ở Đây Thật Tốt!) - RPG Edition
...
const vocabularyList = [
  {
    ...
    "meaning_en": "here",
    "sentence": "在这儿见到你们真好！",
    "sentence_pinyin": "Zài zhè'r jiàndào nǐmen zhēnhǎo!",
    "sentence_vi": "Gặp được các bạn ở đây thật tốt!"
  },
  {
    "word": "遇见",
    "pinyin": "yùjiàn",
    "meaning_vi": "Gặp gỡ, bắt gặp",
    "meaning_en": "meet, run into",
    "sentence": "我没想到会在这里遇见你。",
    "sentence_pinyin": "Wǒ méi xiǎngdào huì zài zhèlǐ yùjiàn nǐ.",
    "sentence_vi": "Tớ không ngờ lại gặp cậu ở đây đấy."
  },
  {
    "word": "真好",
    "pinyin": "zhēnhǎo",
    "meaning_vi": "Thật tốt, quá tốt",
    "meaning_en": "great, wonderful",
    "sentence": "今天的天气真好！",
    "sentence_pinyin": "Jīntiān de tiānqì zhēnhǎo!",
    "sentence_vi": "Thời tiết hôm nay thật tốt!"
  },
  {
    "word": "惊喜",
    "pinyin": "jīngxǐ",
  ...
  },
  {
    ...
    "sentence": "这是一次难忘的旅行。",
    "sentence_pinyin": "Zhè shì yící nánwàng de lǚxíng.",
...
function generatePDF(score) {
  try {
    ...
    doc.text("Chuyen Di Thám Hiem: But Phep Thuat 66", 105, 45, { align: "center" });
    ...
    doc.setFont("helvetica", "normal");
    doc.text("Thanh Pho: Tây An (Bai 66 - Zai zhe'r jian dao ni men zhen hao!)", 70, 80);
...
function sendReportToGChat(score) {
  ...
  const payload = {
    student: "Hana",
    lesson: "Bai 66: Giao dien RPG - Quyết Đấu Boss Tây An",
    score: score,
