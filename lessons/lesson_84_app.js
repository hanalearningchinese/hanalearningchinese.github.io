// ==========================================================================
// APP LOGIC: LESSON 84 (书包里有两本书 - Trong cặp sách có hai quyển sách) - RPG Edition
...
const vocabularyList = [
  {
    ...
    "meaning_en": "cat",
    "sentence": "我家有一只大胖猫。",
    "sentence_pinyin": "Wǒ jiā yǒu yì zhī dà pàng māo.",
    "sentence_vi": "Nhà tớ có một con mèo ú."
  },
  {
    "word": "鱼",
    "pinyin": "yú",
    ...
    "meaning_en": "fish",
    "sentence": "猫喜欢吃鱼。",
    "sentence_pinyin": "Māo xǐhuan chī yú.",
    "sentence_vi": "Mèo thích ăn cá."
  },
  {
    "word": "颜色",
    "pinyin": "yánsè",
    ...
    "sentence_vi": "Cậu thích màu gì?"
  },
  {
    "word": "红色",
    "pinyin": "hóngsè",
    "meaning_vi": "Màu đỏ",
    "meaning_en": "red color",
    "sentence": "苹果是红色的。",
    "sentence_pinyin": "Píngguǒ shì hóngsè de.",
    "sentence_vi": "Táo có màu đỏ."
  },
  {
    "word": "黄色",
    "pinyin": "huángsè",
    "meaning_vi": "Màu vàng",
    "meaning_en": "yellow color",
    "sentence": "香蕉是黄色的。",
    "sentence_pinyin": "Xiāngjiāo shì huángsè de.",
    "sentence_vi": "Chuối có màu vàng."
  },
  {
    "word": "绿色",
    "pinyin": "lǜsè",
    "meaning_vi": "Màu xanh lá cây",
    "meaning_en": "green color",
    "sentence": "西瓜皮是绿色的。",
    "sentence_pinyin": "Xīguā pí shì lǜsè de.",
    "sentence_vi": "Vỏ dưa hấu màu xanh lá."
  },
  {
    "word": "只",
    "pinyin": "zhī",
    "meaning_vi": "Con (lượng từ động vật)",
    "meaning_en": "measure word for animals",
    "sentence": "有一只鸟在树上。",
    "sentence_pinyin": "Yǒu yì zhī niǎo zài shù shang.",
    "sentence_vi": "Có một con chim trên cây."
  },
  {
    "word": "本",
    "pinyin": "běn",
    "meaning_vi": "Quyển, cuốn (sách)",
    "meaning_en": "measure word for books",
    "sentence": "这里有三本书。",
    "sentence_pinyin": "Zhèlǐ yǒu sān běn shū.",
    "sentence_vi": "Ở đây có ba quyển sách."
  }
];
...
function completeQuizGame() {
  ...
  localStorage.setItem('lesson_84_score', finalScore);
  localStorage.setItem('lesson_84_completed', 'true');
...
function generatePDF(score) {
  try {
    ...
    doc.text("Chuyen Di Thám Hiem: But Phep Thuat 84", 105, 45, { align: "center" });
    ...
    doc.setFont("helvetica", "normal");
    doc.text("Thanh Pho: Thành Đô (Bai 84 - Shubaoli you liangben shu)", 70, 80);
    
    doc.setFont("helvetica", "bold");
    doc.text("Huy hieu dat duoc:", 30, 90);
    doc.setFont("helvetica", "normal");
    doc.text("Huy Hieu 🐼 Thành Đô", 70, 90);
    ...
    doc.save("Phieu_diem_Hana_Bai_84.pdf");
  } catch (err) {
...
function sendReportToGChat(score) {
  ...
  const payload = {
    student: "Hana",
    lesson: "Bai 84: Giao dien RPG - Quyết Đấu Boss Thành Đô",
    score: score,
