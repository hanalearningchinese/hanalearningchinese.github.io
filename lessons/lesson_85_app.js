// ==========================================================================
// APP LOGIC: LESSON 85 (你会不会做饭？ - Bạn có biết nấu ăn không?) - RPG Edition
...
const vocabularyList = [
  ...
  },
  {
    ...
    "sentence": "妈妈在厨房做饭。",
    "sentence_pinyin": "Māma zài chúfáng zuòfàn.",
    "sentence_vi": "Mẹ đang nấu ăn trong bếp."
  },
  {
    "word": "医生",
    "pinyin": "yīshēng",
    ...
    "meaning_en": "doctor",
    "sentence": "我想当一名医生。",
    "sentence_pinyin": "Wǒ xiǎng dāng yì míng yīshēng.",
    "sentence_vi": "Con muốn làm một bác sĩ."
  },
  {
    "word": "做饭",
    "pinyin": "zuòfàn",
    "meaning_vi": "Nấu cơm, nấu ăn",
    "meaning_en": "cook, make food",
    "sentence": "我会做饭，你呢？",
    "sentence_pinyin": "Wǒ huì zuòfàn, nǐ ne?",
    "sentence_vi": "Tớ biết nấu ăn, còn cậu thì sao?"
  },
  {
    "word": "会",
    "pinyin": "huì",
    "meaning_vi": "Biết (qua học tập)",
    "meaning_en": "can, know how to",
    "sentence": "你会说汉语吗？",
    "sentence_pinyin": "Nǐ huì shuō Hànyǔ ma?",
    "sentence_vi": "Bạn biết nói tiếng Trung không?"
  },
  {
    "word": "家人",
    "pinyin": "jiārén",
    "meaning_vi": "Người nhà, gia đình",
    "meaning_en": "family members",
    "sentence": "我爱我的家人。",
    "sentence_pinyin": "Wǒ ài wǒde jiārén.",
    "sentence_vi": "Tớ yêu gia đình của tớ."
  },
  {
    "word": "做",
    "pinyin": "zuò",
    ...
    "meaning_en": "do, make",
    "sentence": "你在做什么？",
    "sentence_pinyin": "Nǐ zài zuò shénme?",
    "sentence_vi": "Cậu đang làm cái gì thế?"
  }
];
...
function completeQuizGame() {
  ...
  localStorage.setItem('lesson_85_score', finalScore);
  localStorage.setItem('lesson_85_completed', 'true');
...
function generatePDF(score) {
  try {
    ...
    doc.text("Chuyen Di Thám Hiem: But Phep Thuat 85", 105, 45, { align: "center" });
    ...
    doc.setFont("helvetica", "normal");
    doc.text("Thanh Pho: Bắc Kinh (Bai 85 - Ni hui bu hui zuofan)", 70, 80);
    ...
    doc.save("Phieu_diem_Hana_Bai_85.pdf");
  } catch (err) {
...
function sendReportToGChat(score) {
  ...
  const payload = {
    student: "Hana",
    lesson: "Bai 85: Giao dien RPG - Quyết Đấu Boss Bắc Kinh",
    score: score,
