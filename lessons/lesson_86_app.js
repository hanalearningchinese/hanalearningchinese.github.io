// ==========================================================================
// APP LOGIC: LESSON 86 (包子多少钱一个？ - Bánh bao bao nhiêu tiền một cái?) - RPG Edition
...
const vocabularyList = [
  {
    ...
    "meaning_en": "buy",
    "sentence": "我想买一个书包。",
    "sentence_pinyin": "Wǒ xiǎng mǎi yíge shūbāo.",
    "sentence_vi": "Tôi muốn mua một cái cặp sách."
  },
  {
    "word": "钱",
    "pinyin": "qián",
    ...
    "meaning_en": "money",
    "sentence": "这个多少钱？",
    "sentence_pinyin": "Zhège duōshao qián?",
    "sentence_vi": "Cái này bao nhiêu tiền?"
  },
  {
    "word": "多少钱",
    "pinyin": "duōshaoqián",
    "meaning_vi": "Bao nhiêu tiền",
    "meaning_en": "how much money",
    "sentence": "包子多少钱一个？",
    "sentence_pinyin": "Bāozi duōshao qián yíge?",
    "sentence_vi": "Bánh bao bao nhiêu tiền một chiếc?"
  },
  {
    "word": "块",
    "pinyin": "kuài",
    "meaning_vi": "Đồng, tệ (đơn vị tiền tệ)",
    "meaning_en": "yuan, currency unit",
    "sentence": "这个苹果三块钱。",
    "sentence_pinyin": "Zhège píngguǒ sān kuài qián.",
    "sentence_vi": "Quả táo này giá 3 tệ."
  },
  {
    "word": "茶",
    "pinyin": "chá",
    ...
    "meaning_en": "tea",
    "sentence": "请喝杯热茶吧。",
    "sentence_pinyin": "Qǐng hē bēi rè chá ba.",
    "sentence_vi": "Xin mời uống một ly trà nóng."
  },
  {
    "word": "杯",
    "pinyin": "bēi",
    "meaning_vi": "Cốc, ly (lượng từ)",
    "meaning_en": "cup, glass",
    "sentence": "我要一杯水。",
    "sentence_pinyin": "Wǒ yào yì bēi shuǐ.",
    "sentence_vi": "Cho tôi một cốc nước."
  },
  {
    "word": "太贵了",
    "pinyin": "tàiguìle",
    "meaning_vi": "Đắt quá, đắt thế",
    "meaning_en": "too expensive",
    "sentence": "这个玩具十块钱？太贵了！",
    "sentence_pinyin": "Zhège wánjù shí kuài qián? Tài guì le!",
    "sentence_vi": "Món đồ chơi này 10 tệ á? Đắt quá!"
  }
];
...
function completeQuizGame() {
  ...
  localStorage.setItem('lesson_86_score', finalScore);
  localStorage.setItem('lesson_86_completed', 'true');
...
function generatePDF(score) {
  try {
    ...
    doc.text("Chuyen Di Thám Hiem: But Phep Thuat 86", 105, 45, { align: "center" });
    ...
    doc.setFont("helvetica", "normal");
    doc.text("Thanh Pho: Đôn Hoàng (Bai 86 - Baozi duoshaoqian yige)", 70, 80);
    ...
    doc.save("Phieu_diem_Hana_Bai_86.pdf");
  } catch (err) {
...
function sendReportToGChat(score) {
  ...
  const payload = {
    student: "Hana",
    lesson: "Bai 86: Giao dien RPG - Quyết Đấu Boss Đôn Hoàng",
    score: score,
