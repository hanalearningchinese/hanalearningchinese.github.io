// ==========================================================================
// APP LOGIC: LESSON 88 (马丁比我大三岁 - Martin lớn hơn tôi 3 tuổi) - RPG Edition
...
const vocabularyList = [
  {
    "word": "朋友",
    "pinyin": "péngyou",
    "meaning_vi": "Bạn bè, bạn",
    "meaning_en": "friend",
    "sentence": "他是我的好朋友。",
    "sentence_pinyin": "Tā shì wǒde hǎo péngyou.",
    "sentence_vi": "Cậu ấy là bạn thân của tớ."
  },
  {
    "word": "同学",
    "pinyin": "tóngxué",
    "meaning_vi": "Bạn học cùng lớp",
    "meaning_en": "classmate",
    "sentence": "学校里有很多新同学。",
    "sentence_pinyin": "Xuéxiào lǐ yǒu hěnduō xīn tóngxué.",
    "sentence_vi": "Ở trường có rất nhiều bạn học mới."
  },
  {
    "word": "也",
    "pinyin": "yě",
    ...
    "meaning_en": "also, too",
    "sentence": "我是学生，他也是学生。",
    "sentence_pinyin": "Wǒ shì xuéshēng, tā yě shì xuéshēng.",
    "sentence_vi": "Tôi là học sinh, cậu ấy cũng là học sinh."
  },
  {
    "word": "大",
    "pinyin": "dà",
    "meaning_vi": "To, lớn, nhiều tuổi",
    "meaning_en": "big, old (age)",
    "sentence": "哥哥比我大三岁。",
    "sentence_pinyin": "Gēge bǐ wǒ dà sān suì.",
    "sentence_vi": "Anh trai lớn hơn em 3 tuổi."
  },
  {
    "word": "高",
    "pinyin": "gāo",
    ...
    "sentence": "长颈鹿非常高。",
    "sentence_pinyin": "Chángjǐnglù fēicháng gāo.",
    "sentence_vi": "Chú hươu cao cổ cực kỳ cao."
  },
  {
    "word": "岁",
    "pinyin": "suì",
    "meaning_vi": "Tuổi",
    "meaning_en": "years old",
    "sentence": "Hana今年五岁了。",
    "sentence_pinyin": "Hana jīnnián wǔ suì le.",
    "sentence_vi": "Hana năm nay 5 tuổi rồi."
  }
];
...
function completeQuizGame() {
  ...
  localStorage.setItem('lesson_88_score', finalScore);
  localStorage.setItem('lesson_88_completed', 'true');
...
function generatePDF(score) {
  try {
    ...
    doc.text("Chuyen Di Thám Hiem: But Phep Thuat 88", 105, 45, { align: "center" });
    ...
    doc.setFont("helvetica", "normal");
    doc.text("Thanh Pho: Tây Tạng (Bai 88 - Mading bi wo da sansui)", 70, 80);
    ...
    doc.save("Phieu_diem_Hana_Bai_88.pdf");
  } catch (err) {
...
function sendReportToGChat(score) {
  ...
  const payload = {
    student: "Hana",
    lesson: "Bai 88: Giao dien RPG - Quyết Đấu Boss Tây Tạng",
    score: score,
