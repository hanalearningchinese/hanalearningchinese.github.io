// ==========================================================================
// APP LOGIC: LESSON 89 (你今天做什么了？ - Hôm nay bạn đã làm gì?) - RPG Edition
...
const vocabularyList = [
  {
    "word": "水果",
    "pinyin": "shuǐguǒ",
    "meaning_vi": "Trái cây, hoa quả",
    "meaning_en": "fruit",
    "sentence": "多吃新鲜的水果对身体好。",
    "sentence_pinyin": "Duō chī xīnxiān de shuǐguǒ duì shēntǐ hǎo.",
    "sentence_vi": "Ăn nhiều trái cây tươi rất tốt cho sức khỏe."
  },
  {
    "word": "苹果",
    "pinyin": "píngguǒ",
    ...
    "meaning_en": "apple",
    "sentence": "树上挂着红苹果。",
    "sentence_pinyin": "Shù shang guà zhe hóng píngguǒ.",
    "sentence_vi": "Trên cây treo những quả táo đỏ."
  },
  {
    "word": "香蕉",
    "pinyin": "xiāngjiāo",
    ...
    "meaning_en": "banana",
    "sentence": "猴子喜欢吃香蕉。",
    "sentence_pinyin": "Hóuzi xǐhuan chī xiāngjiāo.",
    "sentence_vi": "Khỉ thích ăn chuối."
  },
  {
    "word": "熊猫",
    "pinyin": "xióngmāo",
    ...
    "meaning_en": "panda",
    "sentence": "熊猫是中国的国宝。",
    "sentence_pinyin": "Xióngmāo shì Zhōngguó de guóbǎo.",
    "sentence_vi": "Gấu trúc là bảo vật quốc gia của Trung Quốc."
  },
  {
    "word": "画",
    "pinyin": "huà",
    "meaning_vi": "Vẽ, bức vẽ",
    "meaning_en": "draw, paint, picture",
    "sentence": "他在本子上画画儿。",
    "sentence_pinyin": "Tā zài běnzi shang huà huàr.",
    "sentence_vi": "Cậu ấy vẽ tranh trên tập vở."
  },
  {
    "word": "没有",
    "pinyin": "méiyǒu",
    "meaning_vi": "Không có, chưa (làm)",
    "meaning_en": "do not have, did not",
    "sentence": "我今天没有去学校。",
    "sentence_pinyin": "Wǒ jīntiān méiyǒu qù xuéxiào.",
    "sentence_vi": "Hôm nay tớ không đến trường học."
  },
  {
    "word": "了",
    "pinyin": "le",
    "meaning_vi": "Rồi (biểu thị hoàn thành)",
    "meaning_en": "particle for completed action",
    "sentence": "我吃了一个苹果。",
    "sentence_pinyin": "Wǒ chī le yíge píngguǒ.",
    "sentence_vi": "Tớ đã ăn một quả táo rồi."
  }
];
...
function completeQuizGame() {
  ...
  localStorage.setItem('lesson_89_score', finalScore);
  localStorage.setItem('lesson_89_completed', 'true');
...
function generatePDF(score) {
  try {
    ...
    doc.text("Chuyen Di Thám Hiem: But Phep Thuat 89", 105, 45, { align: "center" });
    ...
    doc.setFont("helvetica", "normal");
    doc.text("Thanh Pho: Phượng Hoàng (Bai 89 - Ni jintian zuo shenme le)", 70, 80);
    
    doc.setFont("helvetica", "bold");
    doc.text("Huy hieu dat duoc:", 30, 90);
    doc.setFont("helvetica", "normal");
    doc.text("Huy Hieu 🏮 Phượng Hoàng", 70, 90);
    ...
    doc.save("Phieu_diem_Hana_Bai_89.pdf");
  } catch (err) {
...
function sendReportToGChat(score) {
  ...
  const payload = {
    student: "Hana",
    lesson: "Bai 89: Giao dien RPG - Quyết Đấu Boss Phượng Hoàng",
    score: score,
