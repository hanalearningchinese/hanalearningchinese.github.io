// ==========================================================================
// APP LOGIC: LESSON 90 (你怎么了？ - Bạn bị làm sao thế?) - RPG Edition
...
const vocabularyList = [
  {
    ...
    "meaning_en": "hospital",
    "sentence": "生病了要去医院看医生。",
    "sentence_pinyin": "Shēngbìng le yào qù yīyuàn kàn yīshēng.",
    "sentence_vi": "Bị ốm thì cần đến bệnh viện gặp bác sĩ."
  },
  {
    "word": "脚",
    "pinyin": "jiǎo",
    "meaning_vi": "Bàn chân, chân",
    "meaning_en": "foot",
    "sentence": "我的小脚很暖和。",
    "sentence_pinyin": "Wǒde xiǎojiǎo hěn nuǎnhuo.",
    "sentence_vi": "Bàn chân nhỏ của tớ rất ấm áp."
  },
  {
    "word": "手",
    "pinyin": "shǒu",
    "meaning_vi": "Bàn tay, tay",
    "meaning_en": "hand",
    "sentence": "饭前要洗手。",
    "sentence_pinyin": "Fàn qián yào xǐshǒu.",
    "sentence_vi": "Trước khi ăn cơm phải rửa tay."
  },
  {
    "word": "疼",
    "pinyin": "téng",
    "meaning_vi": "Đau",
    "meaning_en": "hurt, painful",
    "sentence": "我头疼，想睡觉。",
    "sentence_pinyin": "Wǒ tóuténg, xiǎng shuìjiào.",
    "sentence_vi": "Tớ bị đau đầu, muốn đi ngủ."
  },
  {
    "word": "怎么了",
    "pinyin": "zěnmele",
    "meaning_vi": "Bị sao thế, làm sao vậy",
    "meaning_en": "what's wrong, what happened",
    "sentence": "你怎么了？不开心吗？",
    "sentence_pinyin": "Nǐ zěnmele? Bù kāixīn ma?",
    "sentence_vi": "Cậu bị làm sao vậy? Không vui à?"
  }
];
...
function completeQuizGame() {
  ...
  localStorage.setItem('lesson_90_score', finalScore);
  localStorage.setItem('lesson_90_completed', 'true');
...
function generatePDF(score) {
  try {
    ...
    doc.text("Chuyen Di Thám Hiem: But Phep Thuat 90", 105, 45, { align: "center" });
    ...
    doc.setFont("helvetica", "normal");
    doc.text("Thanh Pho: Himalaya (Bai 90 - Ni zenme le)", 70, 80);
    ...
    doc.save("Phieu_diem_Hana_Bai_90.pdf");
  } catch (err) {
...
function sendReportToGChat(score) {
  ...
  const payload = {
    student: "Hana",
    lesson: "Bai 90: Giao dien RPG - Quyết Đấu Boss Himalaya",
    score: score,
