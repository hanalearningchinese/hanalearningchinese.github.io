// ==========================================================================
// APP LOGIC: LESSON 91 (我来北京一年了 - Tôi đến Bắc Kinh được một năm rồi) - RPG Edition
...
const vocabularyList = [
  {
    ...
    "meaning_en": "play",
    "sentence": "放学后我们去公园玩吧。",
    "sentence_pinyin": "Fàngxué hòu wǒmen qù gōngyuán wán ba.",
    "sentence_vi": "Sau khi tan học tụi mình đi công viên chơi đi."
  },
  {
    "word": "学习",
    "pinyin": "xuéxí",
    "meaning_vi": "Học tập, học",
    "meaning_en": "study, learn",
    "sentence": "我们要好好学习汉语。",
    "sentence_pinyin": "Wǒmen yào hǎohǎo xuéxí Hànyǔ.",
    "sentence_vi": "Chúng ta phải chăm chỉ học tiếng Trung."
  },
  {
    "word": "运动",
    "pinyin": "yùndòng",
    "meaning_vi": "Vận động, thể thao",
    "meaning_en": "sports, exercise",
    "sentence": "每天运动身体好。",
    "sentence_pinyin": "Měitiān yùndòng shēntǐ hǎo.",
    "sentence_vi": "Mỗi ngày vận động cơ thể sẽ khỏe mạnh."
  },
  {
    "word": "以前",
    "pinyin": "yǐqián",
    "meaning_vi": "Trước đây, trước kia",
    "meaning_en": "before, ago",
    "sentence": "以前我不会骑自行车。",
    "sentence_pinyin": "Yǐqián wǒ búhuì qí zìxíngchē.",
    "sentence_vi": "Trước đây tớ không biết đi xe đạp."
  },
  {
    "word": "每天",
    "pinyin": "měitiān",
    ...
    "sentence": "我每天早上都要喝牛奶。",
    "sentence_pinyin": "Wǒ měitiān zǎoshang dōu yào hē niúnǎi.",
    "sentence_vi": "Mỗi sáng hàng ngày tớ đều phải uống sữa."
  },
  {
    "word": "小时",
    "pinyin": "xiǎoshí",
    "meaning_vi": "Tiếng đồng hồ, giờ",
    "meaning_en": "hour",
    "sentence": "我学习了一个小时。",
    "sentence_pinyin": "Wǒ xuéxí le yíge xiǎoshí.",
    "sentence_vi": "Tớ đã học được một tiếng đồng hồ rồi."
  },
  {
    "word": "分钟",
    "pinyin": "fēnzhōng",
    ...
    "meaning_en": "minute",
    "sentence": "等我十分钟，好吗？",
    "sentence_pinyin": "Děng wǒ shí fēnzhōng, hǎo ma?",
    "sentence_vi": "Đợi tớ 10 phút, được không?"
  }
];
...
function completeQuizGame() {
  ...
  localStorage.setItem('lesson_91_score', finalScore);
  localStorage.setItem('lesson_91_completed', 'true');
...
function generatePDF(score) {
  try {
    ...
    doc.text("Chuyen Di Thám Hiem: But Phep Thuat 91", 105, 45, { align: "center" });
    ...
    doc.setFont("helvetica", "normal");
    doc.text("Thanh Pho: Đầm Lầy (Bai 91 - Wo lai Beijing yinian le)", 70, 80);
    
    doc.setFont("helvetica", "bold");
    doc.text("Huy hieu dat duoc:", 30, 90);
    doc.setFont("helvetica", "normal");
    doc.text("Huy Hieu 🌿 Đầm Lầy", 70, 90);
    ...
    doc.save("Phieu_diem_Hana_Bai_91.pdf");
  } catch (err) {
...
function sendReportToGChat(score) {
  ...
  const payload = {
    student: "Hana",
    lesson: "Bai 91: Giao dien RPG - Quyết Đấu Boss Đầm Lầy",
    score: score,
